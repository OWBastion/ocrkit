                    ...
                    rows[split].append(
                        {
                            ...
                            "candidate_confidence": round(max(line.confidence for line in (rapid_line, vision_line, teacher_line) if line), 4),
                            ...
                            "review_method": "automatic" if auto_reject_reason or auto_accepted or teacher_auto_accepted else "pending",
